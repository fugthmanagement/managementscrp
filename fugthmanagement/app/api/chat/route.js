function buildFallbackResponse(prompt, businessContext, uploads) {
  return [
...
async function fetchGeminiText(prompt, businessContext, uploads, apiKey) {
...
export async function POST(request) {
  try {
    const { prompt, businessContext, uploads } = await request.json();
    ...
    const text = apiKey
      ? await fetchGeminiText(prompt, businessContext, uploads, apiKey)
      : buildFallbackResponse(prompt, businessContext, uploads);
